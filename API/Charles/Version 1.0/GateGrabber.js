//
    ...
    //
    var gate1 = { need: 0, x:(canvas.width/4), y:-20, type:3, rate:1};
    var gate2 = { need: 1, x:(2*(canvas.width/4)), y:-20, type:14, rate:1};
    var gate3 = { need: 0, x:(3*(canvas.width/4)), y:-20, type:9, rate:1};
    ...
    */
    ...
    function checkCollision(){
        ...
        if((gate1.y+60) >= canvas.height){
            resetGates(1);
        } 
        if((gate2.y+60) >= canvas.height){
            resetGates(2);
        } 
        if((gate3.y+60) >= canvas.height){
            resetGates(3);
        }
